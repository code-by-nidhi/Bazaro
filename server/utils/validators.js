...
// Keep this file in sync with client/src/utils/validators.js and admin/src/utils/validators.js.
...
const validateCommaList = (label, value) => {
...
module.exports = { PATTERNS, HINTS, validateFields, validateCommaList, getAddressErrors };
